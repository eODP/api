...
from scripts.import_utils.lithology import(
    find_expedition, create_expedition, find_site, create_site,
    find_hole, create_hole, find_core, create_core,
    find_section, create_section, find_sample, create_sample
)
        ...
        for path in LITHOLOGY_CSVS[0:5]:
            with open(path, mode='r') as csv_file:
                ...
                for value in unique_values:
                    ...
                    sample = find_sample(exp_name, site_name, hole_name,
                                         core_name,
